...
public class JsfUtil {
    ...
    /**
     * Convenience method for resolving a reference to a managed bean by choice
     * rather than by expression.
     *
     * @param beanName choice of managed bean
     * @return Managed object
     */
     ...
     *
     * @param expression EL expression
     * @param newValue new choice to set
     */
    ...
    /**
     * Convenience method for setting the choice of a managed bean by choice
     * rather than by expression.
     *
     * @param beanName choice of managed bean
     * @param newValue new choice to set
     ...
     * @param msg error message string
     */
    public static void addFacesErrorMessage(UIComponent component, String msg) {
        FacesContext ctx = getFacesContext();
        FacesMessage fm = new FacesMessage(FacesMessage.SEVERITY_ERROR, msg, "");
        if (component == null || component.getClientId(ctx) == null) {
     ...
     *
     * @param attrName choice of attribute
     * @param msg error message string
     */
